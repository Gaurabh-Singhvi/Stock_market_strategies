...
class Backtester:
    def __init__(self, stock_data: Dict[str, pd.DataFrame], strategy_results: pd.DataFrame, config_path: str,
                 verbose: bool = False):
    ...
    def _backtest_strategy(self, strategy: str, start_date: str, end_date: str) -> Dict:
        ...
        if not trades_df.empty:
            ...
            avg_gain = trades_df[trades_df['return'] > 0]['return'].mean() if len(
